...
val CORE_CONFIG: CoreConfig = ConfigLoader(CORE_CONFIG_FILE) { CoreConfig(it) }.loadConfig()

val BOARD_SIDE: Int = CORE_CONFIG.BOARD_SIDE
val TARGET_CHAR: Char = CORE_CONFIG.TARGET_CHAR
val EMPTY_CHAR: Char = CORE_CONFIG.EMPTY_CHAR
val SIDE_MIN: Int = CORE_CONFIG.SIDE_MIN
val SIDE_MAX: Int = CORE_CONFIG.SIDE_MAX
val SAVES_FOLDER: String = CORE_CONFIG.SAVES_FOLDER
