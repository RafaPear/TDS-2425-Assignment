...
[![Release Tests](https://img.shields.io/github/actions/workflow/status/RafaPear/Reversi-Grupo1/release-tests.yml?event=release&label=release%20tests)](https://github.com/RafaPear/Reversi-Grupo1/actions/workflows/release-tests.yml)
